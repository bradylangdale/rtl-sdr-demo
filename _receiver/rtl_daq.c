...
#define CFN "_receiver/rec_control_fifo" /* Receiver control FIFO name */
    ...
    */
    ...
    while(!exit_flag){
	    ...
	    reconfig_trigger = 0;
            ...
            rtlsdr_set_gpio(rtl_receivers[1].dev, 1, 0);
            rtlsdr_set_gpio(rtl_receivers[2].dev, 1, 0);
            rtlsdr_set_gpio(rtl_receivers[3].dev, 1, 0);
        ...
        else if ( (char) signal == 'f')
        {
            ...
            rtlsdr_set_gpio(rtl_receivers[1].dev, 0, 0);
            rtlsdr_set_gpio(rtl_receivers[2].dev, 0, 0);
            rtlsdr_set_gpio(rtl_receivers[3].dev, 0, 0);
